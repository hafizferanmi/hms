...
import { useIsAuthTokenExpired } from "../../../hooks/useAuthToken";
...
const Loginpage = () => {
  ...
  const isTokenExpired = useIsAuthTokenExpired();

  return (
    <>
      {!isTokenExpired ? (
        <Redirect to="/secure/admin" />
      ) : (
          ...
          <div className={classes.loginPageBackgroundFade}>
            ...
            <div className={classes.agreementTextWrapper}>
              <Typography component="p" variant="body2">
                By continuing, you're confirming that you've read our Terms
