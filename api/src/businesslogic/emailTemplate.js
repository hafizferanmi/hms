...
export const addEmailTemplate = async (req, res) => {
  ...
  const { value, errorMsg } = validateRequestBody(EmailTemplateSchema, req.body)
...
export const updateEmailTemplate = async (req, res) => {
  ...
  try {
    const emailTemplate = await EmailTemplate.findOneAndUpdate(conditons, emailTemplateData, { new: true })
    return res.json(success(emailTemplate))
  } catch (e) {
...
export const getEmailTemplate = async (req, res) => {
  ...
  try {
    const template = await EmailTemplate.findOne({ _id: templateId, companyId })
    return res.json(success(template))
  } catch (e) {
    res.json(failed('Error occured, could not fetch email template'))
  }
}
...
export const getEmailTemplates = async (req, res) => {
  ...
  try {
    ...
    res.json(failed('Error occured, could not fetch email templates'))
  }
}
...
export const deleteEmailTemplate = async (req, res) => {
  ...
  try {
    const template = await EmailTemplate.findOneAndDelete({ _id: templateId, companyId })
    return res.json(success(template))
  } catch (e) {
    res.json(failed('Error occured, could not fetch email templates'))
  }
